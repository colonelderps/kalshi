...
if __name__ == "__main__":
    try:
        ...
        if cloud_lib.is_transient_block(e):
            ...
            # network). Not our bug, no data lost -- watermark didn't advance,
            # so the next run recovers the gap. Exit 0 to avoid a noise
            # "workflow failed" email. (Note: this workflow is disabled; local
            # collector is the social source. Kept consistent for parity.)
